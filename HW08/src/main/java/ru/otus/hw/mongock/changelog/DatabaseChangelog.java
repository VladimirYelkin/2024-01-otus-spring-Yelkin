...
public class DatabaseChangelog {
    ...
    public void insertAuthors(AuthorRepository repository) {
        var authors = List.of(
                new Author("Author_1"), new Author("Author_2"), new Author("Author_3"));
    ...
    public void insertGenres(GenreRepository repository) {
        List<Genre> genres = List.of(
                new Genre("Genre_1"), new Genre("Genre_2"), new Genre("Genre_3"),
                new Genre("Genre_4"), new Genre("Genre_5"), new Genre("Genre_6"));
    ...
    public void insertBooks(BookRepository repository) {
        ...
        var books = List.of(
                new Book("BookTitle_1", authorMap.get("Author_1"), genresBook1),
                new Book("BookTitle_2", authorMap.get("Author_2"), genresBook2),
                new Book("BookTitle_3", authorMap.get("Author_3"), genresBook3));
    ...
    public void insertComments(CommentRepository repository) {
        savedBooks.stream()
                .map(savedBook -> new Comment("Comment for book id: %s".formatted(savedBook.getId()), savedBook))
